...
- **Web**: Next.js 15.5, React 19.1, React Native Web, Dexie.js
...
- `HONO_API_URL` - External API URL (optional)
...
- **Local JSON files** in `apps/web/databases/` for TB Bible and guides
- **External API** for other Bible translations (via `apps/web/utils/hono-api.ts`)
- **Dexie.js** for IndexedDB abstraction to store downloaded Bible data
- **Shared types** in `packages/app/types/api.ts` for Bible and guide data structures
