    ...
    >
      <div className="mx-7 flex max-w-sm items-center justify-between sm:mx-auto sm:max-w-md landscape:mx-auto">
        <button
          ...
          className={`h-12 w-12 transform rounded-full bg-white p-3 shadow-md transition duration-300 focus:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 ${
            isBibleByDateLoading ||
            isBibleByPassageLoading ||
            (inGuide
              ? isFirstPassageInGuide
        ...
        <button
          ...
          className={`h-12 w-12 transform rounded-full bg-white p-3 shadow-md transition duration-300  hover:bg-gray-100 focus:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 ${
            isBibleByDateLoading ||
            isBibleByPassageLoading ||
